---
title: "Analysis of Landsat 8 raster images of Mexico"
...
To do the masking and select only the region corresponding to Mexico I used a [https://geodata.lib.berkeley.edu/catalog/stanford-zc863pb5331](polygon shapefile) made by Hijmans, Robert J. from the Museum of Vertebrate Zoology at UC Berkeley. 
...
In this section we create a map that outlines zones in Mexico with dense vegetation ($0.5\leq NDVI$), with code based on [https://github.com/oharac/esm244_w2021_lab6_rasters](this repository) by C. O'Hara.
